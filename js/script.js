...
window.onload = function() {
    ...
    setTimeout(function() {
        ...
        // Atualiza o texto de status durante o carregamento
        setTimeout(() => statusText.textContent = 'Verificando dados...', 1500);
        setTimeout(() => statusText.textContent = 'Quase pronto...', 3500);
        setTimeout(() => statusText.textContent = 'Finalizado!', 4800);
